...
import { useCodeEditorStore } from "../../../code-snipp/src/store/useCodeEditorStore";
import { THEMES } from "../constants";  
import { AnimatePresence, motion } from "framer-motion";
import { CircleOff, Cloud, Github, Laptop, Moon, Palette, Sun } from "lucide-react";
import useMounted from "../../../code-snipp/src/hooks/useMounted";
...
function ThemeSelector() {
  ...
  // Remove unnecessary useEffect hooks for setMounted
 if (!mounted) return null; 
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      rounded-lg transition-all duration-200 border-gray-800/50 hover:border-gray-700"
      >
